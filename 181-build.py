...
for SERVER_URL in SERVER_URLS:
    ...
    lab.create_node(name='s1-router', template='Cisco IOSv 15.5(3)M', x=-454, y=-9)
    router1 = lab.get_node("s1-router")
    router1.start()

    lab.create_node(name='s2-router', template='Cisco IOSv 15.5(3)M', x=-218, y=-9)
    router2 = lab.get_node("s2-router")
    router2.start()

    lab.create_node(name='s3-router', template='Cisco IOSv 15.5(3)M', x=66, y=-9)
    router3 = lab.get_node("s3-router")
    router3.start()

    lab.create_node(name='s4-router', template='Cisco IOSv 15.5(3)M', x=334, y=-9)
    ...
    lab.create_node(name='s1-dhcp', template='Windows Server 2022', x=-354, y=200)
    server3 = lab.get_node("s1-dhcp")
    server3.start()

    lab.create_node(name='s2-dhcp', template='Windows Server 2022', x=-118, y=200)
    server4 = lab.get_node("s2-dhcp")
    server4.start()
    
    lab.create_node(name='s3-dhcp', template='Windows Server 2022', x=150, y=200)
    server5 = lab.get_node("s3-dhcp")
    server5.start()

    lab.create_node(name='s4-dhcp', template='Windows Server 2022', x=410, y=200)
    ...
    lab.create_link("s1-switch", "Gi0/1", "s1-ubuntu", "Ethernet0")
    lab.create_link("s2-switch", "Gi0/1", "s2-ubuntu", "Ethernet0")
    lab.create_link("s3-switch", "Gi0/1", "s3-ubuntu", "Ethernet0")
    lab.create_link("s4-switch", "Gi0/1", "s4-ubuntu", "Ethernet0")

    lab.create_link("s1-switch", "Gi0/2", "s1-dhcp", "Ethernet0")
    lab.create_link("s2-switch", "Gi0/2", "s2-dhcp", "Ethernet0")
    lab.create_link("s3-switch", "Gi0/2", "s3-dhcp", "Ethernet0")
    lab.create_link("s4-switch", "Gi0/2", "s4-dhcp", "Ethernet0")
