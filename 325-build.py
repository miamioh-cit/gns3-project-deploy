...
for SERVER_URL in SERVER_URLS:
    ...
    lab.create_link("mid-sw", "Gi0/0", "mid-l", "eth0")
    lab.create_link("mid-sw", "Gi0/1", "mid-w", "NIC1")
    ...
    lab.create_link("oxf-l", "eth0", "NAT-2", "nat0")
    lab.create_link("jenkins-server", "eth0", "NAT-3", "nat0")
    lab.create_link("mid-l", "eth0", "NAT-4", "nat0")
    lab.create_link("ham-l", "eth0", "NAT-5", "nat0")
    lab.create_link("mid-w", "NIC2", "NAT-6", "nat0")
    lab.create_link("ham-w", "NIC2", "NAT-7", "nat0")
    lab.create_link("ham-sw", "Gi0/0", "ham-l", "eth0")
