...
for SERVER_URL in SERVER_URLS:
    ...
    lab.create_node(name='NAT-1', template='NAT', x='220', y='-320')
    ...
    lab.create_link("mgmt-sw", "Gi0/1", "oxf-l", "eth0")
    lab.create_link("mgmt-sw", "Gi0/2", "mid-l", "eth0")
    lab.create_link("mgmt-sw", "Gi0/3", "mid-w", "NIC1")
    lab.create_link("mgmt-sw", "Gi1/0", "mid-rtr", "Gi0/0")
    lab.create_link("mgmt-sw", "Gi1/1", "ham-rtr", "Gi0/0")
    lab.create_link("mgmt-sw", "Gi1/2", "ham-w", "NIC1")
    lab.create_link("mgmt-sw", "Gi1/3", "ham-l", "eth0")
    ...
    lab.create_link("mgmt-rtr", "Gi0/1", "NAT-1", "nat0") 
    lab.create_link("mid-sw", "Gi0/0", "mid-l", "eth1")
    lab.create_link("mid-sw", "Gi0/1", "mid-w", "NIC2")
    
    lab.create_link("mid-sw", "Gi1/0", "mid-rtr", "Gi0/1")
    lab.create_link("reg-rtr", "Gi0/0", "ham-rtr", "Gi0/1")
    lab.create_link("reg-rtr", "Gi0/1", "mid-rtr", "Gi0/2")
    lab.create_link("oxf-l", "eth1", "NAT-2", "nat0")
    lab.create_link("jenkins-server", "eth1", "NAT-3", "nat0")
    lab.create_link("mid-l", "eth2", "NAT-4", "nat0")
    #lab.create_link("ham-l", "eth2", "NAT-5", "nat0")
