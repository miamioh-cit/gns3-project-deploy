...
for SERVER_URL in SERVER_URLS:
    ...
    lab.create_node(name='switzerland-pc1', template='VPCS', x='-257', y='-704').start()
    lab.create_node(name='switzerland-pc2', template='VPCS', x='-257', y='-629').start()
    lab.create_node(name='switzerland-pc5', template='VPCS', x='-257', y='-554').start()
    lab.create_node(name='switzerland-pc6', template='VPCS', x='-257', y='-479').start()
    lab.create_node(name='switzerland-pc3', template='VPCS', x='42', y='-704').start()
    lab.create_node(name='switzerland-pc4', template='VPCS', x='42', y='-629').start()
    lab.create_node(name='switzerland-pc7', template='VPCS', x='42', y='-554').start()
    lab.create_node(name='switzerland-pc8', template='VPCS', x='42', y='-479').start()
    lab.create_node(name='switzerland-web', template='VPCS', x='35', y='-225').start()

    lab.create_node(name='india-pc1', template='VPCS', x='-932', y='-329').start()
    lab.create_node(name='india-pc2', template='VPCS', x='-857', y='-329').start()
    lab.create_node(name='india-pc5', template='VPCS', x='-707', y='-329').start()
    lab.create_node(name='india-pc6', template='VPCS', x='-632', y='-331').start()
    lab.create_node(name='india-web', template='VPCS', x='-561', y='-331').start()
    lab.create_node(name='india-pc3', template='VPCS', x='-932', y='-104').start()
    lab.create_node(name='india-pc4', template='VPCS', x='-857', y='-104').start()
    lab.create_node(name='india-pc7', template='VPCS', x='-707', y='-104').start()
    lab.create_node(name='india-pc8', template='VPCS', x='-632', y='-104').start()

    lab.create_node(name='europe-web', template='VPCS', x='-407', y='45').start()
    lab.create_node(name='europe-pc1', template='VPCS', x='-932', y='45').start()
    lab.create_node(name='europe-pc2', template='VPCS', x='-857', y='45').start()    
    lab.create_node(name='europe-pc5', template='VPCS', x='-707', y='45').start()
    lab.create_node(name='europe-pc6', template='VPCS', x='-632', y='45').start()
    lab.create_node(name='europe-pc3', template='VPCS', x='-932', y='270').start()
    lab.create_node(name='europe-pc4', template='VPCS', x='-857', y='270').start()
    lab.create_node(name='europe-pc7', template='VPCS', x='-707', y='270').start()
    lab.create_node(name='europe-pc8', template='VPCS', x='-632', y='270').start()

    lab.create_node(name='america-pc1', template='VPCS', x='-932', y='420').start()
    lab.create_node(name='america-pc2', template='VPCS', x='-857', y='420').start()
    lab.create_node(name='america-pc5', template='VPCS', x='-707', y='420').start()
    lab.create_node(name='america-pc6', template='VPCS', x='-632', y='420').start()
    lab.create_node(name='america-pc3', template='VPCS', x='-932', y='645').start()
    lab.create_node(name='america-pc4', template='VPCS', x='-857', y='645').start()
    lab.create_node(name='america-pc7', template='VPCS', x='-707', y='645').start()
    lab.create_node(name='america-pc8', template='VPCS', x='-632', y='645').start()
    lab.create_node(name='america-web', template='VPCS', x='-407', y='645').start()

    lab.create_node(name='japan-web', template='VPCS', x='339', y='-328').start()
    lab.create_node(name='japan-pc1', template='VPCS', x='417', y='-329').start()
    lab.create_node(name='japan-pc2', template='VPCS', x='492', y='-329').start()
    lab.create_node(name='japan-pc5', template='VPCS', x='642', y='-329').start()
    lab.create_node(name='japan-pc6', template='VPCS', x='717', y='-329').start()
    lab.create_node(name='japan-pc3', template='VPCS', x='417', y='-104').start()
    lab.create_node(name='japan-pc4', template='VPCS', x='492', y='-104').start()
    lab.create_node(name='japan-pc7', template='VPCS', x='642', y='-104').start()
    lab.create_node(name='japan-pc8', template='VPCS', x='717', y='-104').start()

    lab.create_node(name='china-pc1', template='VPCS', x='417', y='45').start()
    lab.create_node(name='china-pc2', template='VPCS', x='492', y='45').start()
    lab.create_node(name='china-pc5', template='VPCS', x='642', y='45').start()
    lab.create_node(name='china-pc6', template='VPCS', x='717', y='45').start()
    lab.create_node(name='china-pc3', template='VPCS', x='417', y='270').start()
    lab.create_node(name='china-pc4', template='VPCS', x='492', y='270').start()
    lab.create_node(name='china-pc7', template='VPCS', x='642', y='270').start()
    lab.create_node(name='china-pc8', template='VPCS', x='717', y='270').start()
    lab.create_node(name='china-web', template='VPCS', x='192', y='45').start()

    lab.create_node(name='germany-pc1', template='VPCS', x='422', y='420').start()
    lab.create_node(name='germany-pc2', template='VPCS', x='492', y='420').start()
    lab.create_node(name='germany-pc5', template='VPCS', x='642', y='420').start()
    lab.create_node(name='germany-pc6', template='VPCS', x='717', y='420').start()   
    lab.create_node(name='germany-pc3', template='VPCS', x='417', y='645').start()
    lab.create_node(name='germany-pc4', template='VPCS', x='492', y='645').start()       
    lab.create_node(name='germany-pc7', template='VPCS', x='639', y='645').start()
    lab.create_node(name='germany-pc8', template='VPCS', x='716', y='645').start()
    lab.create_node(name='germany-web', template='VPCS', x='192', y='645').start()
